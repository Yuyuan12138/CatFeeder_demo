...
/*********************需要修改的地方**********************/
const char* ssid = "TP-LINK_3A12";           //WIFI名称
const char* password = "13770449798";     //WIFI密码
int capture_interval = 15 * 1000;      // 默认20秒上传一次，可更改（本项目是自动上传，如需条件触发上传，在需要上传的时候，调用take_send_photo()即可）
const char*  uid = "6c74d90b4dea49868dd2f953fed6279a";    //用户私钥，巴法云控制台获取
